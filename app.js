...
var $author$project$Main$initialModel = F2(
	function (key, url) {
		return {
			...
			key: key,
			recipeCount: 6,
			recipes: A2($elm$core$List$take, 6, $author$project$Recipe$recipes),
			url: url
		};
	});
...
var $author$project$Main$appendRecipes = F2(
	function (list, model) {
		return _Utils_eq(list, _List_Nil) ? model.recipes : _Utils_ap(model.recipes, list);
	});
...
var $author$project$Main$filterRecipes = F2(
	function (model, query) {
		return (query === '') ? $author$project$Recipe$recipes : A2(
			$elm$core$List$filter,
			function (recipe) {
				return A2($elm$core$String$contains, query, recipe.title);
			},
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ScrollEvent':
				...
				var offsetHeight = msg.a.offsetHeight;
				if (_Utils_cmp(scrollHeight - scrollTop, offsetHeight) < 1) {
					var num = model.recipeCount + 3;
					var lisfOfRecipes = $elm$core$Array$toList(
						A3(
							$elm$core$Array$slice,
							model.recipeCount,
							num,
							$elm$core$Array$fromList($author$project$Recipe$recipes)));
					var appendedRecipes = A2($author$project$Main$appendRecipes, lisfOfRecipes, model);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{recipeCount: num, recipes: appendedRecipes}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Main$displayActiveRecipe = function (recipe) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('active-recipe')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('active-recipe-title')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('active-recipe-img'),
						$elm$html$Html$Attributes$src(recipe.photo_src)
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('active-recipe-description')
					]),
				recipe.description)
			]));
};
...
var $author$project$Main$filterRecipesInput = function (model) {
	var _v0 = model.activeRecipe;
	if (_v0.$ === 'Nothing') {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Main$scrollInfoDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$ScrollInfo,
	A2(
		$elm$json$Json$Decode$at,
		_List_fromArray(
			['target', 'scrollHeight']),
...
var $author$project$Main$recipeList = function (model) {
	...
	if (_v0.$ === 'Nothing') {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('recipes-container'),
					$author$project$Main$onScroll($author$project$Main$ScrollEvent)
				]),
			A2($elm$core$List$map, $author$project$Main$recipeCard, model.recipes));
	} else {
		var recipe = _v0.a;
		return A2($elm$html$Html$div, _List_Nil, _List_Nil);
	}
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$filterRecipesInput(model),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								$author$project$Main$recipeList(model),
								function () {
								var _v0 = model.activeRecipe;
								if (_v0.$ === 'Nothing') {
									return A2($elm$html$Html$div, _List_Nil, _List_Nil);
									...
									var recipe = _v0.a;
									return $author$project$Main$displayActiveRecipe(recipe);
								}
							}()
							]))
					]))
